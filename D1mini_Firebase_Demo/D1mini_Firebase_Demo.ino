...
#define _SSID "Gjun207"        // Your WiFi SSID
#define _PASSWORD "Gjun@3474878"    // Your WiFi Password
#define PROJECT_ID "xxxx"   // Your Firebase Project ID. Can be found in project settings.
  ...
  //#define FINGERPRINT "77 D3 44 9B E0 38 CE 7E CF 7D 1C 07 11 59 2B 26 E0 26 22 F0"
  ...
  Firebase firebase(PROJECT_ID);    // SLOW BUT HASTLE-FREE METHOD FOR LONG TERM UGE. DOES NOT REQUIRE PERIODIC UPDATE OF FINGERPRINT
